...
export default function PrivacyPage() {
  const title = 'GNSS Calculator | Privacy Policy';
    ...
    <>
      ...
      <>
        ...
        <p>
          ...
          transmitted to a Google server in the USA and stored there. In the
          event that IP anonymization is activated on this website, however,
          your IP address will be truncated beforehand by Google within member
          states of the European Union or in other contracting states to the
          ...
          and shortened there. Google will use this information for the purpose
