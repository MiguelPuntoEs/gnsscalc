...
export default function Positioning() {
  const title: string = 'GNSS Calculator | Positioning Calculator';
      ...
      <Layout title={title}>
        ...
        <section className={styles.glossary}>
          ...
          <div>
            ...
            <p>
              <strong>&Delta;N</strong> [m] is the North component of the
              entered position in the reference local coordinate system
              East-North-Up (&Delta;e, &Delta;n, &Delta;u) expressed in meters.
            </p>
            <p>
